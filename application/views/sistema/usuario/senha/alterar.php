...
echo form_open('sistema/usuario/senha/salvar');?>
    <div class="row">
	...
	<div class="row">
		<div class="small-12 medium-6 large-8 medium-push-6 large-push-4 column">
			<div data-abide-error class="primary callout">
                ...
                <p>Por questões de segurança o sistema exige que você altere sua senha para manter restrito o acesso aos dados usados neste ambiente, somente aos usuários autorizados pelo administrador.</p>
            </div>
		</div>
		<div class="small-12 medium-6 large-4 medium-pull-6 large-pull-8 column">
			...
			<div class="row">
				...
				<?php if($this->config->item('pular-resenha')){?>
					<a href="./sistema/usuario/senha/adiar" class="is-button-bar-menu button" style="" data-icone="">Alterar depois</a>
				<?php } ?>
			</div>
		</div>
	</div>
